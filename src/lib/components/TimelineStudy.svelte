        ...
        <article class="study-card">
            ...
            <div class="content-wrapper">
                <div class="card-header">
                    <!-- Added fallbacks depending on how your API columns are named -->
                    <h3>{opleiding.Titel || opleiding.Functie}</h3>
                    <span class="year-badge">{opleiding.Jaar_begonnen} - {opleiding.Jaar_gestopt}</span>
                </div>
                <p class="school">{opleiding.School || opleiding.Werkgever}</p>
                <p class="desc">
